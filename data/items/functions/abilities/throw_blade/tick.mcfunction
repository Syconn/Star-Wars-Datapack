...
execute as @a if entity @s[scores={bc=1..,shift_time=..0},nbt={SelectedItem:{"id":"minecraft:warped_fungus_on_a_stick",tag:{lightsaber:1b,on:1b}}}] run function items:abilities/throw_blade/throw
